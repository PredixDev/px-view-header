...
function runBaseTests() {
  px_header_1 = document.getElementById('px_header_1');

  suite('Base Automation Tests for px-view-header', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-view-header fixtures are created', function() {
      assert.isTrue(document.getElementById('px-view-header-1') !== null);
      assert.isTrue(document.getElementById('px-view-header-2') !== null);
      assert.isTrue(document.getElementById('px-view-header-3') !== null);
    });
